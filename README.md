...
*Hit threshold*
To find each golf shot, the code searchs for audio peaks that are above the HIT_THRESHOLD parameter. This should a float between 0 and 1 (min noise and max noise, respectively)
